...
urlpatterns += [
    ...
    path('geriatric/relationships/', views.RelationshipListView.as_view(), name='relationships'),
    path('geriatric/relationship/<int:pk>/', views.RelationshipDetailView.as_view(), name='relationship-detail'),
    path('geriatric/relationship/create/', views.RelationshipCreate.as_view(), name='relationship-create'),
    path('geriatric/relationship/<int:pk>/update/', views.RelationshipUpdate.as_view(), name='relationship-update'),
    path('geriatric/relationship/<int:pk>/delete/', views.RelationshipDelete.as_view(), name='relationship-delete'),
